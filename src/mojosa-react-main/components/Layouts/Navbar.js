...
class Navbar extends React.Component {
    ...
    render() {
        ...
        let layOutCls = '';
        let logo = require('../../images/logoComparateur.png');
                    ...
                    <div id="navbar" className={`crake-nav ${layOutCls}`}>
                        <div className="container">
                            <nav className="navbar navbar-expand-md navbar-light">
                                <Link href="/saas">
                                    <a className="hero-content">
                                        <h1 style={{color : "#fff", fontSize:"31px", fontWeight:700}}>Le Comparateur.com</h1>
                                    </a>
                                </Link>
                                    ...
                                    <ul className="navbar-nav nav ml-auto">
                                        <li className="nav-item">
                                            <Link activeClassName="active" href="#">
                                                <a className="nav-link" style={{fontWeight:"700"}}>Assurance emprunteur</a>
                                            </Link>
                                        ...
                                        <li className="nav-item"><a href="#" className="nav-link" style={{fontWeight:"700"}}>Prêt immobilier</a>
                                            <ul className="dropdown_menu">
                                                <li className="nav-item">
                                                    <Link activeClassName="active" href="#">
